  ...
  return (
    <div name="home" className="w-full min-h-screen bg-[#0a192f] ">
      <div className="max-w-[1000px]  mx-auto px-8 pt-12 flex flex-col  justify-center min-h-screen text-white md:pt-0">
        ...
        <h1 className="xs:text-2xl sm:text-3xl md:text-4xl  font-bold">Milos Mirkovic</h1>
        ...
        <div>
          ...
          onClick={handleViewWork}
            className="btn group text-white border-2 px-6 py-2 flex items-center sm:text-lg md:text-xl   hover:bg-blue-600 active:border-blue-600">
            View Work
